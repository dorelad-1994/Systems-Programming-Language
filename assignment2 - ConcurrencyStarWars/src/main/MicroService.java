...
public abstract class MicroService implements Runnable {
    ...
    public final void run() {
        ...
        initialize();
        // leia awaits for the countdown latch before sending attacks, this is where the other threads "notify" her they finished initializing
        ...
        while (true) {
            try {
                ...
                Callback<Message> callback = callbacks.get(message.getClass());
